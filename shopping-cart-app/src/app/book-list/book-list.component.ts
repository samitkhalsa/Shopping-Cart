...
export class BooksListComponent implements OnInit {
  ...
  deleteBook(book) {
    if (window.confirm('Are sure you want to delete this book ?')) { // Asking from user before Deleting student data.
      this.crudApi.DeleteBook(book.$key) // Using Delete student API to delete student.
      this.toastr.success(book.name + ' successfully deleted!'); // Alert message will show up when student successfully deleted.
    }
  }
